	...
	<div class="container">
		<form method="post" action="/project/parking/report/write"
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label" style="text-align: center">이메일</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="titleForm" name="title"
						placeholder="여기를 이메일을 변경할 수 있게끔 바꿔야 할듯" required>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input class="form-control" id="contentForm" name="content"
						placeholder="여기도 닉네임을 바꿀수 있게 해야할듯" required></input>
				</div>
			</div>
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label" style="text-align: center">비밀번호
					확인</label>
				<div class="col-sm-10">
					<input class="form-control" id="contentForm" name="content"
						placeholder="여기도 닉네임을 바꿀수 있게 해야할듯" required></input>
